    ...
    <main class="form-signin w-100 m-auto">
      <form action="product-register" method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" name="product_name" id="floatingfirsname"placeholder="Ingrese su nombre"
                 required pattern="[A-Za-z0-9]{2,40}">
          <label for="floatingfirsname">Nombre</label>
        </div>
        <br>
        <div class="form-floating">
          <input type="number" class="form-control" name="product_value" id="floatingLastname"placeholder="Ingrese su apellido"
                 required pattern="[0-9]{2,40}">
          <label for="floatingLastname">Apellido</label>
        </div>
        <br>
        <div class="form-floating">
          <input type="number" class="form-control" name="category_id" id="floatingEmail"placeholder="Ingrese su Gmail"
                 required autofocus>
